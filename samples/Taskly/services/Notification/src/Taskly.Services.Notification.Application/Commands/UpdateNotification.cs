...
public sealed class UpdateNotification(Guid id, 
    string name,
    string? search,
    IEnumerable<string>? tags,
    Guid? sectionId,
    Guid? goalId,
    UpdateNotification.UpdateNotificationSchedule schedule)
    : ICommand<Empty>
{
    ...
    public UpdateNotificationSchedule Schedule { get; } = schedule;

    public sealed class UpdateNotificationSchedule(ReminderSchedule reminderSchedule, ScheduleFrequency scheduleFrequency, int? customOffsetValue, TimeSpan sendTime)
    {
