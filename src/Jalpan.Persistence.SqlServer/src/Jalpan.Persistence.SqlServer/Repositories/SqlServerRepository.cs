...
namespace Jalpan.Persistence.SqlServer.Repositories;

public class SqlServerRepository<TEntity, TIdentifiable>(DbContext context) : ISqlServerRepository<TEntity, TIdentifiable> where TEntity : class
{
