...
{
    private const string SectionName = "webApiSecurity";
    private const string RegistryName = "webApi.security";

    public static IJalpanBuilder AddCertificateAuthentication(this IJalpanBuilder builder,
