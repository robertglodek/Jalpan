...
public sealed class DeleteNotificationScheduleHandler(IContextProvider contextProvider,
    INotificationScheduleRepository notificationRepository,
    ILogger<DeleteNotificationScheduleHandler> logger) : ICommandHandler<DeleteNotification, Empty>
{
