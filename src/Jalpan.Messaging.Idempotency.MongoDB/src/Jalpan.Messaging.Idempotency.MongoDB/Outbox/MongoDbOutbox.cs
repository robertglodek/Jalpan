...
internal class MongoDbOutbox : IOutbox
{
    ...
    private readonly IMongoDbRepository<OutboxMessage, string> _outboxRepository;
    private readonly IDateTime _dateTime;
    private readonly IMessageBrokerClient _messageBrokerClient;
    private readonly IJsonSerializer _jsonSerializer;
    private readonly ILogger<MongoDbOutbox> _logger;
    private readonly MethodInfo _sendMethod;

    public bool Enabled { get; }

    public MongoDbOutbox(IMongoDbRepository<OutboxMessage, string> outboxRepository, IDateTime dateTime,
        IMessageBrokerClient messageBrokerClient, IJsonSerializer jsonSerializer,
        IOptions<OutboxOptions> options, ILogger<MongoDbOutbox> logger)
    {
    ...
    private async Task SendMessageAsync(OutboxMessage outboxMessage, CancellationToken cancellationToken)
    {
        ...
        var sendMessageTask = sendMethod.Invoke(_messageBrokerClient, [envelope, cancellationToken]);
